...
describe AddressUri do
  ...
  describe "generate_address" do
    ...
    it "Should return the request URI in developer trending page when the language is set to 'css' and the date is not" do
      address.developer = true
      address.language = 'css'
      expect(address.generate_address).to eql('https://github.com/trending/developers/css?since=daily')
    end

    it "Should return the request URI in developer trending page when the language is set to 'html' and the date is not" do
      address.developer = true
      address.language = 'html'
    ...
    it "Return request URI for repositories trending when the language is not specified and the date is set to 'week'" do
      address.date = 'week'
      expect(address.generate_address).to eql('https://github.com/trending?since=weekly')
    end

    it "Return request URI for repositories trending when the language is not specified and the date is set to 'month'" do
      address.date = 'month'
